...
sudo cp "$self_dir/wslg-xwayland.socket" /lib/systemd/system/wslg-xwayland.socket
sudo cp "$self_dir/wslg-xwayland.service" /lib/systemd/system/wslg-xwayland.service
